...
namespace iod {
    ...
    static void parse_command_line(int argc, const char *argv[],
        ...
        for (int ai = 1; ai < argc; ai++) {
            ...
            if (len > 1) {
                ...
                /* 3 dashes n*/
                if ((len <= ndash) || !isalpha(arg[ndash]))
                    ndash = 0;
            }
    ...
    namespace cl {
        ...
        template<typename... T>
        auto special(T &&... s) {
            return s::_iod_pcl_special = std::make_tuple(s...);
        }
    }
    ...
    auto parse_command_line(std::tuple<A...> attrs, int argc, const char *argv[],
        ...
        auto specials = attrs_sio.get(_iod_pcl_special, std::make_tuple());
        ...
        if (std::tuple_size<typeof(specials)>::value > 0) {
            bool has_special = 0;
            foreach(specials) | [&](auto s) {
                /* if any special argument is specified return immediately */
    ...
    auto parse_command_line(std::tuple<Q...> attrs,
                            ...
                            assign_exp <_iod_pcl_special_t, PS> ps,
                            T &&... opts) {
